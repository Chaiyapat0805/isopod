...
export function PandaKing({ navigation }) {
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={{ bottom: 55, fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}> Cubaris sp. "Panda King" </Text>
      ...
      <Text style={{ bottom: 27, fontSize: 16, textAlign: 'center' }}> ความชื้น: 80 เปอร์เซ็น </Text>
