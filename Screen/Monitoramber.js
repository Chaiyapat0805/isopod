...
export function Monitoramber({ navigation }) {

    const [Name, setname] = React.useState(0);
    const [Size, setsize] = React.useState(0);
    const [Age, setage] = React.useState(0);

    const getAmber = async () => {
