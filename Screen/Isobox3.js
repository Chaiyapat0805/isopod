...
export function Isobox3({ navigation }) {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.box}>
                ...
                <Text style={styles.textbox}> Armadillidium BOX </Text>
                ...
                <Text style={styles.texttemp}> 18-31 °C </Text>

                <Image source={require('../imge/isocare/iconhum.png')} style={styles.imageicon2} />
                <Text style={styles.texthum}> 60 % </Text>
