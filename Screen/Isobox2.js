...
export function Isobox2({ navigation }) {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.box}>
                ...
                <Image source={require('../imge/IsopodTypeimg/9.png')} style={styles.imageicon} />

                <Text style={styles.textbox}> Porcellio BOX </Text>
                ...
                <Text style={styles.texthum}> 50-55 % </Text>
