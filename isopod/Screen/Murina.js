    ...
    return (
      <View style={styles.container}>
        <Image
          ...
          resizeMode= 'contain'
          source={require('./picture/3.png')}/>
        <Text style={{ bottom: 320, fontSize: 25, textAlign: 'center'}}> ISOTYPE </Text>
        <Text style={{ bottom: 55, fontSize: 18, fontWeight: 'bold', textAlign: 'center'}}> Cubaris sp. "Murina" </Text>
        ...
        <Text style={{ bottom: 28, fontSize: 15, textAlign: 'center'}}> ความชื้น: 70 - 80 เปอร์เซ็น </Text>
        <Text style={{ bottom: 26, fontSize: 15, textAlign: 'center'}}> อุณหภูมิ: 18 - 31 องศาเซลเซียส </Text>
