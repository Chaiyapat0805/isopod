...
export function GiantOrange({ navigation }) {
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
        ...
        resizeMode='contain'
        source={require('../imge/IsopodTypeimg/9.png')} />
      <Text style={{ bottom: 310, fontSize: 25, textAlign: 'center' }}> ISOTYPE </Text>
      <Text style={{ bottom: 55, fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}> Porcellio laevis "Giant Orange" </Text>
      <Text style={{ bottom: 45, fontSize: 16, textAlign: 'center' }}> ลักษณะและการเป็นอยู่ </Text>
      <Text style={{ bottom: 28, fontSize: 16, textAlign: 'center' }}> ขนาด: 1 - 1.5 เซนติเมตร </Text>
      <Text style={{ bottom: 27, fontSize: 16, textAlign: 'center' }}> ความชื้น: 50 - 55 เปอร์เซ็น </Text>
      <Text style={{ bottom: 26, fontSize: 16, textAlign: 'center' }}> อุณหภูมิ: 18 - 28 องศาเซลเซียส </Text>
