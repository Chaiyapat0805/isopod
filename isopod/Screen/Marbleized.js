...
export function Marbleized({ navigation }) {
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
        ...
        resizeMode='contain'
        source={require('../imge/IsopodTypeimg/8.png')} />
      <Text style={{ bottom: 310, fontSize: 25, textAlign: 'center' }}> ISOTYPE </Text>
      <Text style={{ bottom: 55, fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}> Armadilliduim "Marbleized" </Text>
      ...
      <Text style={{ bottom: 27, fontSize: 16, textAlign: 'center' }}> ความชื้น: 50 - 60 เปอร์เซ็น </Text>
