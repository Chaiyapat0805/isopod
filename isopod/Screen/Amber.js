...
export function Amber({ navigation }) {
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
        ...
        resizeMode='contain'
        source={require('../imge/IsopodTypeimg/5.png')} />
      <Text style={{ bottom: 310, fontSize: 25, textAlign: 'center' }}> ISOTYPE </Text>
      <Text style={{ bottom: 55, fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}> Cubaris sp. "Amber" </Text>
      <Text style={{ bottom: 45, fontSize: 16, textAlign: 'center' }}> ลักษณะและการเป็นอยู่ </Text>
      <Text style={{ bottom: 28, fontSize: 16, textAlign: 'center' }}> ขนาด: 1 - 1.2 เซนติเมตร </Text>
      <Text style={{ bottom: 27, fontSize: 16, textAlign: 'center' }}> ความชื้น: 70 - 80 เปอร์เซ็น </Text>
